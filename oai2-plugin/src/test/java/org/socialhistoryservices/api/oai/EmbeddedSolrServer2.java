 ...
 * @since solr 1.3
 */
public class EmbeddedSolrServer2 extends SolrClient {
    ...
    public NamedList<Object> getParsedResponse(SolrQueryRequest request, SolrQueryResponse response) {
        return BinaryResponseWriter.getParsedResponse(request, response);
    }
     ...
     */
    public EmbeddedSolrServer2(Path solrHome, String defaultCoreName) {
     ...
     */
    public EmbeddedSolrServer2(NodeConfig nodeConfig, String defaultCoreName) {
     ...
     */
    public EmbeddedSolrServer2(CoreContainer coreContainer, String coreName) {
